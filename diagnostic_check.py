...
def run_diagnostic(args):
    ...
    config = FingerprintConfig(
        ...
        min_messages_per_fingerprint=5, # Lowered for test.json
        window_step_size=2,
    ...
    logger.info(f"Configuration: min_messages={config.min_messages}, min_messages_per_fingerprint={config.min_messages_per_fingerprint}")
    ...
    try:
        ...
        train_X, train_y, val_X, val_y, test_X, test_y, _, _ = system.prepare_dataset(df)
